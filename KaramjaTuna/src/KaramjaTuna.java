...
@ScriptManifest(author = "Author", name = "Karamja Tuna", version = 1.0, logo = "", info = "Fishes for Tuna on Karamja, banking at Port Sarrim deposit box.")
public class KaramjaTuna extends Script {

    
    private int tunaCaught;
